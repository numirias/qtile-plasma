# flake8: noqa
# pylint: skip-file
# This is an exact copy of lib/enum.py from Python 3.6 to make Flag and auto
# available in Python 3.5 without extra dependencies.
# https://github.com/python/cpython/blob/3.6/Lib/enum.py
